...
const NameMetric = "Storage Per Type"
...
export default function GraphicsStoragePerType({ data }: Props) {
	// eslint-disable-next-line @typescript-eslint/no-explicit-any
	const chartData: any[] = Object.entries(data?.storage_per_type).map(([ext, count], index) => ({
		browser: ext,
		data: count,
