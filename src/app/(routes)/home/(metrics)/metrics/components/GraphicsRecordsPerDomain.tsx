...
const NameMetric = "Records Per Domain"
...
export default function GraphicsRecordsPerDomain({ data }: Props) {
	// eslint-disable-next-line @typescript-eslint/no-explicit-any
	const chartData: any[] = Object.entries(data?.records_per_domain).map(([ext, count], index) => ({
		browser: ext,
		data: count,
